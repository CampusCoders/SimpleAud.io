document.addEventListener('DOMContentLoaded', function () {
    ...
    var convertButton = document.getElementsByClassName("convert-button");
        ...
        xhr.onload = function (e) {
            if (this.readyState === 4) {
                ...
                if (isStemsMidiFormVisible) {
                    ...
                    console.log("Stems+MIDI Form action güncellendi: " + approvalForm2.action);
                } else {
                    ...
                    if (isOnlyMidiFormVisible) {
                        ...
                        console.log("Only MIDI Form action güncellendi: " + approvalForm2.action);
                    }
                }
            }
        };
...
document.getElementById("local-upload-form").addEventListener("change", function(event) {
    var selectedFileName = event.target.files[0].name;
    document.getElementById("secilenDosya").textContent = "Seçilen dosya: " + selectedFileName;
});

document.getElementById("only-midi-local-upload-form").addEventListener("change", function(event) {
    var selectedFileName = event.target.files[0].name;
    document.getElementById("secilenDosyaOnly").textContent = "Seçilen dosya: " + selectedFileName;
});
